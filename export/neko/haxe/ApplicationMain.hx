...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("GameProject1", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("GameProject1", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "GameProject1";
		app.meta["name"] = "GameProject1";
